...
var c_8383 = (new goog.debug.Console());
var G__8382_8384 = c_8383.getFormatter();
goog.object.set(G__8382_8384,"showAbsoluteTime",false);

goog.object.set(G__8382_8384,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_8383);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__8385_SHARP_){
return goog.object.get(figwheel.repl.logging.LogLevel,p1__8385_SHARP_);
