...
var file = cljs.core.get.call(null,map__17259__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
}catch (e17258){var _e = e17258;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___17261 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___17261)){
var seen_errors_17262 = temp__5733__auto___17261;
if(cljs.core.truth_(seen_errors_17262.has(self))){
} else {
seen_errors_17262.add(self);

var temp__5735__auto___17263 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___17263)){
var sense_17264 = temp__5735__auto___17263;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_17264)].join(''));
} else {
}
}
} else {
