...
var o14778 = temp__5733__auto__;
var temp__5733__auto____$1 = (o14778["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o14779 = temp__5733__auto____$1;
return (o14779["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__13887__auto__ = f;
return (o__13887__auto__["toString"]).call(o__13887__auto__);
} else {
return "";
}
}catch (e14780){var _ = e14780;
return "";
}});
...
try{var o__13887__auto___14782 = t;
(o__13887__auto___14782["cljs$lang$ctorPrWriter"]).call(o__13887__auto___14782,t,writer);
}catch (e14781){var __14783 = e14781;
}
...
var char_code = (function (){var o__13887__auto__ = (new String(char$));
return (o__13887__auto__["charCodeAt"]).call(o__13887__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__13887__auto__ = String;
return (o__13887__auto__["fromCharCode"]).call(o__13887__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__14784 = num_code;
switch (G__14784) {
case (1):
return (185);
...
var o__13887__auto__ = String;
return (o__13887__auto__["fromCharCode"]).call(o__13887__auto__,superscript_code);
});
/**
...
}catch (e14786){var _e__13894__auto__ = e14786;
return false;
}})())){
...
var vec__14787 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__14787,(0),null);
...
var temp__5733__auto____$1 = (o14790["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o14791 = temp__5733__auto____$1;
return (o14791["nameToPath"]);
} else {
return null;
}
} else {
...
args__4742__auto__.push((arguments[i__4737__auto___14799]));
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__14794){
var vec__14795 = p__14794;
var ns_detector = cljs.core.nth.call(null,vec__14795,(0),null);
...
var G__14801 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__14802 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__14801;
remaining_tokens = G__14802;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq14792){
var G__14793 = cljs.core.first.call(null,seq14792);
var seq14792__$1 = cljs.core.next.call(null,seq14792);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14793,seq14792__$1);
}));
...
var vec__14806 = cljs.core.split_with.call(null,(function (p1__14805_SHARP_){
return cljs.core.not_EQ_.call(null,p1__14805_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__14806,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__14806,(1),null);
...
var vec__14812 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__14812,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__14812,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__14815 = cljs.core.rest.call(null,remaining_tokens);
var G__14816 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__14815;
...
var vec__14819 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__14819,(0),null);
var arity = cljs.core.nth.call(null,vec__14819,(1),null);
var vec__14822 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__14822,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__14822,(1),null);
var vec__14825 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__14825,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__14825,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__14825,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__14825,(3),null);
...
var vec__14831 = result;
var munged_ns = cljs.core.nth.call(null,vec__14831,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__14831,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__14831,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__14831,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__14831,(4),null);
var arity = cljs.core.nth.call(null,vec__14831,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__14835 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__14835,(0),null);
var args = cljs.core.nth.call(null,vec__14835,(1),null);
var vec__14838 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__14841 = (arity + (1));
var G__14842 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__14843){
var vec__14844 = p__14843;
var arity = cljs.core.nth.call(null,vec__14844,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__14844,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__14847_SHARP_){
return cljs.core.get.call(null,arities,p1__14847_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__14848_SHARP_){
return cljs.core.drop.call(null,(2),p1__14848_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___14855 = arguments.length;
var i__4737__auto___14856 = (0);
while(true){
if((i__4737__auto___14856 < len__4736__auto___14855)){
args__4742__auto__.push((arguments[i__4737__auto___14856]));

var G__14857 = (i__4737__auto___14856 + (1));
i__4737__auto___14856 = G__14857;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__14851){
var vec__14852 = p__14851;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__14852,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq14849){
var G__14850 = cljs.core.first.call(null,seq14849);
var seq14849__$1 = cljs.core.next.call(null,seq14849);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14850,seq14849__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__14860__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__14860__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__14860__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__14860__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__14861 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__14861,(0),null);
var fn_name = cljs.core.nth.call(null,vec__14861,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__14861,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__14861,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__14861,(4),null);
var arity = cljs.core.nth.call(null,vec__14861,(5),null);
...
var o__13887__auto__ = f;
return (o__13887__auto__["getBasis"]).call(o__13887__auto__);
});
/**
...
}catch (e14865){var _e__13894__auto__ = e14865;
...
var G__14866 = (obj[cljs.core.first.call(null,path)]);
var G__14867 = cljs.core.rest.call(null,path);
obj = G__14866;
path = G__14867;
continue;
} else {
...
var _STAR_ = (function (accum,p__14868){
var vec__14869 = p__14868;
var bit = cljs.core.nth.call(null,vec__14869,(0),null);
var protocol = cljs.core.nth.call(null,vec__14869,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__14872){
var vec__14873 = p__14872;
var ns = cljs.core.nth.call(null,vec__14873,(0),null);
var name = cljs.core.nth.call(null,vec__14873,(1),null);
var selector = cljs.core.nth.call(null,vec__14873,(2),null);
...
var post_process = (function (p__14877){
var vec__14878 = p__14877;
var munged_name = cljs.core.nth.call(null,vec__14878,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__14878,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__14876_SHARP_){
return (obj[cljs.core.first.call(null,p1__14876_SHARP_)]);
}),sorted_matches);
