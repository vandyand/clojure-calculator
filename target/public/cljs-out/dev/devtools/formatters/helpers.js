...
var G__14883 = devtools.prefs.pref.call(null,v);
v = G__14883;
continue;
} else {
return v;
...
}catch (e14886){var _e__13894__auto__ = e14886;
return false;
}})();
...
}catch (e14890){var _e__13894__auto__ = e14890;
return false;
}})();
...
}catch (e14892){var _e__13894__auto__ = e14892;
return false;
}}
}
});
...
var vec__14894 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__14894,(0),null);
var name = cljs.core.nth.call(null,vec__14894,(1),null);
...
return cljs.core.some.call(null,(function (p1__14897_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__14897_SHARP_);
}),template);
});
