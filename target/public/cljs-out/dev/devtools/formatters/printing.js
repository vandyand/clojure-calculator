...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq14909){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14910,G__14911,seq14909__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__14915_SHARP_){
return (!((cljs.core.meta.call(null,p1__14915_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__14916__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e14920){var _e__13894__auto__ = e14920;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e14922){var _e__13894__auto__ = e14922;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__14924 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__14925 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__14925);

try{var map__14926 = opts;
...
var markup_db = cljs.core.get.call(null,map__14926__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__14924);
}});
...
var temp__5733__auto___14931 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___14931)){
var managed_print_level_14932 = temp__5733__auto___14931;
var _STAR_print_level_STAR__orig_val__14929_14933 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__14930_14934 = managed_print_level_14932;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__14930_14934);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__14928_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__14928_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__14929_14933);
}} else {
job_fn.call(null);
}
