...
var G__14026 = o;
goog.object.set(G__14026,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__14028__i < G__14028__a.length) {G__14028__a[G__14028__i] = arguments[G__14028__i + 0]; ++G__14028__i;}
  args = new cljs.core.IndexedSeq(G__14028__a,0,null);
} 
...
var G__14030 = o;
goog.object.set(G__14030,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__14032__i < G__14032__a.length) {G__14032__a[G__14032__i] = arguments[G__14032__i + 0]; ++G__14032__i;}
  args = new cljs.core.IndexedSeq(G__14032__a,0,null);
} 
...
var G__14034 = props;
var G__14034__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__14034,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__14034);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__14034__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__14035 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__14035,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__14035;
}
})(),id_class);
...
var G__14036 = (cljs.core.count.call(null,argv) - first_child);
switch (G__14036) {
case (0):
...
var vec__14038 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__14038,(0),null);
var id = cljs.core.nth.call(null,vec__14038,(1),null);
var className = cljs.core.nth.call(null,vec__14038,(2),null);
...
var temp__5739__auto___14041 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___14041 == null)){
} else {
var key_14042 = temp__5739__auto___14041;
(jsprops.key = key_14042);
}
...
var temp__5739__auto___14043 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___14043 == null)){
} else {
var key_14044 = temp__5739__auto___14043;
(jsprops.key = key_14044);
}
...
var temp__5739__auto___14045 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5739__auto___14045 == null)){
} else {
var key_14046 = temp__5739__auto___14045;
(jsprops.key = key_14046);
}
...
var temp__5739__auto___14047 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___14047 == null)){
} else {
var key_14048 = temp__5739__auto___14047;
(jsprops.key = key_14048);
}
...
var temp__5739__auto___14049 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___14049 == null)){
} else {
var key_14050 = temp__5739__auto___14049;
(jsprops.key = key_14050);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__14051_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__14051_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__14052 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__14052,(0),null);
var derefed = cljs.core.nth.call(null,vec__14052,(1),null);
...
break;
default:
var G__14057 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__14058 = compiler;
v = G__14057;
compiler = G__14058;
continue;
...
var G__14059 = tag;
var G__14059__$1 = (((G__14059 instanceof cljs.core.Keyword))?G__14059.fqn:null);
switch (G__14059__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template14062 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template14062 = (function (opts,id,fn_to_element,parse_fn,meta14063){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template14062.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14064,meta14063__$1){
var self__ = this;
var _14064__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template14062(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta14063__$1));
}));

(reagent.impl.template.t_reagent$impl$template14062.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14064){
var self__ = this;
var _14064__$1 = this;
return self__.meta14063;
}));

(reagent.impl.template.t_reagent$impl$template14062.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template14062.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template14062.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template14062.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template14062.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template14062.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta14063","meta14063",-553612533,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template14062.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template14062.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template14062");

(reagent.impl.template.t_reagent$impl$template14062.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template14062");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template14062.
 */
reagent.impl.template.__GT_t_reagent$impl$template14062 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template14062(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta14063){
return (new reagent.impl.template.t_reagent$impl$template14062(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta14063));
});

}

return (new reagent.impl.template.t_reagent$impl$template14062(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
